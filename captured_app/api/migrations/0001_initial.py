    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ca_procedure', models.CharField(max_length=20, null=True)),
                ('ca_criterion', models.CharField(max_length=20, null=True)),
                ('anb_type', models.CharField(max_length=20, null=True)),
                ('anb_sector', models.CharField(max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anb_name', models.CharField(max_length=55)),
